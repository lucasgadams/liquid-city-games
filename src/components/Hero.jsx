        ...
        <div className="flex justify-between">
          <div className="">
            <h1 className="text-2xl font-medium tracking-tight text-gray-900">
              Build your own brewery and defeat the evil Baron Von Bitter
            </h1>
            <p className="mt-6 text-lg text-gray-600">
              Leverage your brewery skills for this addicting game!
            </p>
          </div>
          <Image src="/gameShot.jpg" width={256} height={128} />
        </div>
      </Container>
    </div>
  )
